...
public class CardGame {
    ...
    public void step(Queue deck1, Queue deck2) {
        ...
        System.out.println("The result of the step " + step +": \n" + deck1 + "\n" + deck2);
        if (step >= 106) {
            gameOver = true;
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Insert 5 cards for the first deck:");
        for (int i = 1; i <= 5; i++) {
            game.addCard(firstDeck, input.nextInt());
        }
        System.out.println("insert 5 cards for the second deck:");
        for (int i = 1; i <= 5; i++) {
